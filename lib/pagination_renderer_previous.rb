...
# Tells WP how to render the "Next Page" link
  def previous_page
    ...
    previous_or_next_page(@collection.previous_page,  '<div class="hover-move"><img src="assets/previous.png" alt="previous"/></div>', 'previous_pagination') if @collection.previous_page
  end
