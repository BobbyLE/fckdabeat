...
# Tells WP how to render the "Next Page" link
  def next_page
    ...
    previous_or_next_page(@collection.next_page,  '<img src="assets/next.png" alt="next" class="hover-move"/><img src="assets/barre.png"/>', 'next_pagination') if @collection.next_page
  end
